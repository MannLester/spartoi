...
program
  .command('init')
  .description('Initialize backend-shadcn configuration inside your project')
  .action(() => {
    const cwd = process.cwd();
    console.log('🚀 Initializing backend-shadcn environment...');
...
program
  ...
  .action((moduleId, options) => {
    ...
    const readmeContent = [
      ...
      'Generated by Backend-Shadcn Framework tooling mechanisms.',
      '',
